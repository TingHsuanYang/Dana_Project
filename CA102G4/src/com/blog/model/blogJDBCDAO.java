...
public class blogJDBCDAO implements blogDAO_interface {
	...
	private static final String GET_ALL_BY_KEYWORD = "SELECT * FROM BLOG WHERE (BLOG_STATUS = 0 AND UPPER(BLOG.BLOG_TITLE) LIKE UPPER(?)) OR (BLOG_STATUS = 0 AND UPPER(BLOG.BLOG_CONTENT) LIKE UPPER(?)) ORDER BY BLOG_DATE DESC";
	// 取得4個發文日期最新的部落格文章
	...
	public static void main(String args[]) throws IOException {
		...
		// 刪除一個部落格文章
		// int updateCount_delete = dao.delete("B000007");

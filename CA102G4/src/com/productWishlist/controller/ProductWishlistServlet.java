	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("insert".equals(action)) { // 來自addProductReport.jsp的請求  
			...
			try {
				...
				java.sql.Timestamp product_wishlist_time = null;
				try {
					product_wishlist_time = java.sql.Timestamp.valueOf(req.getParameter("product_wishlist_time").trim());
				} catch (IllegalArgumentException e) {
					product_wishlist_time = new java.sql.Timestamp(System.currentTimeMillis());
					errorMsgs.add("請輸入日期!");
				}
				...
				String url = "/productWishlist/listAllProductWishlist.jsp";
				RequestDispatcher successView = req.getRequestDispatcher(url); // 修改成功後,轉交listOneProductWishlist.jsp
				...
				RequestDispatcher failureView = req.getRequestDispatcher("/productWishlist/addProductWishlist.jsp");
				failureView.forward(req, res);
			}
		}

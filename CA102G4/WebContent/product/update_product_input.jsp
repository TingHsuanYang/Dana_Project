...
<table>
	...
	<tr>
		<td>商品賣家編號:<font color=red><b>*</b></font></td>
	...
	<tr>
		<td>商品名稱:</td>
		<td><input type="TEXT" name="product_name" size="30" value="<%=productVO.getProduct_name()%>" /></td>
	</tr>
	<tr>
		<td>商品價格:</td>
		<td><input type="TEXT" name="product_price" size="30" value="<%=productVO.getProduct_price()%>" /></td>
	</tr>
		
	<tr>
		<td>商品描述:</td>
		<td><input type="TEXT" name="product_descr" size="30" value="<%=productVO.getProduct_descr()%>" /></td>
	</tr>
		
	<tr>
		<td>商品庫存:</td>
		<td><input type="TEXT" name="product_stock" size="10" value="<%=productVO.getProduct_stock()%>" /></td>
	</tr>
	...
	<tr>
		<td>商品照片1:</td>
		<td><input type="FILE" id="product_photo_1" name="product_photo_1" value="<%=productVO.getProduct_photo_1()%>" /></td>
	...
	<tr>
		<td>商品照片2:</td>
		<td><input type="FILE" id="product_photo_2" name="product_photo_2" value="<%=productVO.getProduct_photo_2()%>" /></td>
		...
		<tr>
		<td>商品照片3:</td>
		<td><input type="FILE" id="product_photo_3" name="product_photo_3" value="<%=productVO.getProduct_photo_3()%>" /></td>
		...
		<tr>
		<td>商品照片4:</td>
		<td><input type="FILE" id="product_photo_4" name="product_photo_4" value="<%=productVO.getProduct_photo_4()%>" /></td>
	...
	<tr>
		<td>商品照片5:</td>
		<td><input type="FILE" id="product_photo_5" name="product_photo_5" value="<%=productVO.getProduct_photo_5()%>" /></td>
...
<input type="hidden" name="product_mem_id" value="<%=productVO.getProduct_mem_id()%>">
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=productVO.getProduct_date()%>'
 		   // value:   new Date(),

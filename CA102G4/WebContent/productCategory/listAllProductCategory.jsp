...
<html>
<head>
<title>所有商品類別資料 - listAllProductCategory.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>所有商品類別資料 - listAllProductCategory.jsp</h3>
...
<table>
	...
	<c:forEach var="productCategoryVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			<td>${productCategoryVO.product_category_id}</td>
			<td>${productCategoryVO.product_category_name}</td>

			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/productCategory/productCategory.do" style="margin-bottom: 0px;">
